...
Gem::Specification.new do |spec|
  ...
  #   spec.metadata["source_code_uri"] = "https://github.com/yusufsheiqh/text_wrapper"
  #   spec.metadata["changelog_uri"] = "https://github.com/yusufsheiqh/text_wrapper/blob/master/CHANGELOG.md"
  # else
